...
async function moveAndRenameFile() {
  const sourceFolder = '/home/neroin/Development/Project/NodeJs/mitso-nodejs-basic/src/fs/files'; // Путь к исходной папке
  const destinationFolder = '/home/neroin/Development/Project/NodeJs/mitso-nodejs-basic/src/fs/files_rename'; // Путь к целевой папке
